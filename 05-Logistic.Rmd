...
exp(beta1 * 100)
```
Holding carapace width constant, a one gram increase in weight is associated with a `r exp(beta1 * 100)` multiplicative change in the odds of having satellites.
